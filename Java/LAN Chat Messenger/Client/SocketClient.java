                ...
                if(msg.type.equals("message")){
                    ...
                    if(JOptionPane.showConfirmDialog(ui, ("Accept '"+msg.content+"' from "+msg.sender+" ?")) == 0){
						...
						*/
						...
						System.out.println("Share Req If");
						...
						DisplayClient dc=new DisplayClient(addr);
                        ...
                        //t.start();
                        send(new Message("share_res", ui.username, "2020" , msg.sender));
                    }
                    else{
						System.out.println("Share Req Else");
                        send(new Message("share_res", ui.username, "NO", msg.sender));
                    }
                }
                    ...
                    if(!msg.content.equals("NO")){
                        int port  = Integer.parseInt(msg.content);
                        String addr = msg.sender;
						System.out.println("Share Res If"+addr+" "+port);
