...
public class ChatFrame extends javax.swing.JFrame {
    ...
    public String historyFile = "C:/Users/Sarvesh/Desktop/Project/History.xml";
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String target = jList1.getSelectedValue().toString();
        if(!target.isEmpty()){
			jButton9.setEnabled(false);
			jButton10.setEnabled(true);   
            client.send(new Message("share_req", username, "Screen Share", target));
			try{
				long interval = 5;
            ...
            jTextArea1.append("[Application > Me] : Not Able to Share Screen\n");
		}
    }//GEN-LAST:event_jButton6ActionPerformed
	
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
		jButton10.setEnabled(false);
