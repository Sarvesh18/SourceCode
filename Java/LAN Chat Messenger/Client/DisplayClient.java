//displayclient.DisplayClient.java
...
public class DisplayClient extends Thread implements KeyListener, MouseListener
{
	...
	public DisplayClient(String addr) 
	{
		try 
		{
			add = JOptionPane.showInputDialog(null,"Server Address",InetAddress.getByName(addr));
			
			s = new Socket(InetAddress.getByName(addr), 2020);
