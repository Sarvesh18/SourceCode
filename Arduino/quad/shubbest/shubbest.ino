  ...
  changech2 = pulseIn(3, HIGH, 25000);
   ...
   // {
           ...
           Setpoint2= Setpoint1 = 3.63;    // Pitch
            ...
            Output1    = map(Output1, 0, 500, 0,  20);
            Output2    = map(Output2, 0, 500, 0,  20);
            Output3    = map(Output3, 0, 500, 0,  20);
            Output4    = map(Output4, 0, 500, 0,  20);
...
//=========================== 1 ======*/  // Pitch BWD 
    if( ypr[1] >= (yprd[0] + low2) &&     ypr[2] >= (yprd[1] - low2)  &&  ypr[2] <= (yprd[1] + low2))    
    {
      ...
      m[1] = constrain(throttle_val+5  - Output1, 0, motormax);
...
//=========================== 2 ======*/  // Pitch FWD  
    if( ypr[1] <= (yprd[0] - low2) &&     ypr[2] >= (yprd[1] - low2)  &&  ypr[2] <= (yprd[1] + low2) )  
    {
     ...
     // myPID2.Compute();    
      ...
      m[1] = constrain(throttle_val+5  + Output2, 0, motormax);
...
//===================== ====== 3 ======*/  // Roll LEFT
    ...
    Output1=0;
     // myPID3.Compute();     
      ...
      m[1] = constrain(throttle_val+5  - Output3, 0, motormax);
...
//=========================== 4 ======*/  // Roll RIGHT  
    if( ypr[2] >= (yprd[1] + low2) &&     ypr[1] >= (yprd[0] - low2)  &&  ypr[1] <= (yprd[0] + low2) )
    {
     ...
     Output1= 0; 
      ...
      m[1] = constrain(throttle_val+5  + Output4, 0, motormax);
...
//================================= 5 ======*/  // Picth Bwd && Roll Right
    ...
    Output2=0;
      ...
      m[1] = constrain(throttle_val+5 +  Output1 + Output4, 0, motormax);
...
//=========================== 6 ======*/  // Picth Bwd && Roll Left  
    ...
    Output2=0;
     ...
     // myPID3.Compute();          
      ...
      m[1] = constrain(throttle_val+5 - Output1 - Output3, 0, motormax);
...
//=========================== 7 ======*/  // Picth Fwd && Roll Left  
   ...
   //   myPID3.Compute();        
      ...
      m[1] = constrain(throttle_val+5 +Output2 - Output3, 0, motormax);
...
//=========================== 8 ======*/  // Picth Fwd && Roll Right  
  ...
  //    myPID2.Compute();       
    //  myPID4.Compute();        
      ...
      m[1] = constrain(throttle_val+5  + Output2 + Output4, 0, motormax);
